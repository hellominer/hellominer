...
专业矿池代理，支持 ETH、ETC、BTC、TON、ERG、RVN、LTC、XMR、CFX、KDA、ALPH，可免费定制软件内置抽水账号，打造专属自己的版本，有需要进群找群主。
...
1. 支持主流币种：ETH、ETC、BTC、TON、ERG、RVN、LTC、XMR、CFX、KDA、ALPH，后续支持更多，欢迎进群反馈。
...
## 安全小贴士
1、提供公共代理的老铁们，要知道`币印矿池`，如果矿机通过一个中转入口，中转到你的代理，那么`币印矿池`会把你的代理IP直接显示在矿机使用者的后台，你的代理IP就被暴露出来了，容易受到攻击。
